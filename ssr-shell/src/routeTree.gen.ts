...
import { Route as Mfe1SplatRouteImport } from './routes/mfe1.$'
...
const Mfe1SplatRoute = Mfe1SplatRouteImport.update({
  id: '/mfe1/$',
  path: '/mfe1/$',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  Mfe1SplatRoute: typeof Mfe1SplatRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/mfe1/$': {
      ...
      path: '/mfe1/$'
      fullPath: '/mfe1/$'
      preLoaderRoute: typeof Mfe1SplatRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/posts/': {
      id: '/posts/'
