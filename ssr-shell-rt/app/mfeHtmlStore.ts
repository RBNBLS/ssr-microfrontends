...
// route's loader data — the framework serializes all loader data into the page
// for hydration, which would ship the entire MFE document a second time on
// every request. The loader stores the HTML here and returns only a token.
//
